    ...
    <div className="flex justify-center bg-white  min-w-[800px] min-h-screen">
      <div className=" flex-col w-[90%]">
        ...
        <div className="flex space-x-7 border-b">
          <p
            className={`${tabState == 1 ? "staffTab-active" : "staffTab"}`}
            onClick={() => {
              setTabState(1);
            }}
          >
          ...
          <p
            className={`${tabState == 2 ? "staffTab-active" : "staffTab"}`}
            onClick={() => {
              setTabState(2);
            }}
          >
            ผู้ป่วยเก่าไม่มีใบนัด
          </p>
          <p
            className={`${tabState == 3 ? "staffTab-active" : "staffTab"}`}
            onClick={() => {
              setTabState(3);
            }}
          >
